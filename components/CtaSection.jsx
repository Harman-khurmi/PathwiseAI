...
const CtaSection = () => {
  return (
    ...
    <Title title="Your career needs direction. Let's " gradientText="guide it" />
    <h3 className='text-text-dark/80 dark:text-text-light/80 text-center w-2/3'>Join thousands of professionals who are moving forward with clarity, confidence, and direction.</h3>
      </div>
